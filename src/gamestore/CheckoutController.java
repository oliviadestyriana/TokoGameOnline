...
public class CheckoutController {
    ...
    protected Alert createInfoAlert() {
        ...
        alert.getDialogPane().setContentText("Selamat!, Sekarang Anda dapat memainkan game dari Librari.");
        alert.getDialogPane().setHeaderText("Pembelian Anda Berhasil.");
        alert.showAndWait()
    ...
    protected Alert createErrorAlert() {
        ...
        alert.initModality(Modality.APPLICATION_MODAL);
        alert.initOwner(stage);
        alert.getDialogPane().setContentText("Cek Saldo anda dan Coba Lagi");
        alert.getDialogPane().setHeaderText("Saldo Anda Tidak Cukup.");
        alert.showAndWait()
                .filter(response -> response == ButtonType.OK);
        return alert;
    }
